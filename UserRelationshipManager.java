...
public class UserRelationshipManager {
    ...
    public void followUser(String follower, String followed, NotificationsManager notificationManager) throws IOException {
        ...
        notificationManager.addNotification("New follower");
